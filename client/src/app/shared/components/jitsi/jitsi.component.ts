...
export class JitsiComponent extends BaseComponent implements OnDestroy {
    ...
    private async setUp(): Promise<void> {
        ...
        this.configService
            .get<boolean>('general_system_auto_connect_conference')
            .subscribe(autoconnect => (this.autoconnect = autoconnect));

        this.configService.get<boolean>('general_system_show_audio_conference').subscribe(show => {
