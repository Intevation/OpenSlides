...
def get_config_variables():
    ...
    yield ConfigVariable(
        ...
        choices=(
            ...
            {"value": "openslides-dgb-light-theme", "display_name": "DGB"},
            {"value": "openslides-evg-light-theme", "display_name": "EVG"},
            {"value": "openslides-gew-light-theme", "display_name": "GEW"},
            {"value": "openslides-igbau-light-theme", "display_name": "IG BAU"},
            {"value": "openslides-igbce-light-theme", "display_name": "IG BCE"},
            {"value": "openslides-igm-light-theme", "display_name": "IG Metall"},
            {"value": "openslides-verdi-light-theme", "display_name": "ver.di"},
        ),
        weight=154,
        subgroup="System",
    )
